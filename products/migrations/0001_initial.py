# Generated by Django 3.2.2 on 2021-05-12 17:41
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('activity_type', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='products.activitytype')),
                ...
                ('dinning_option', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='products.dinningoption')),
                ('dinning_type', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='products.dinningtype')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=45)),
                ('service_type', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='products.servicetype')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='room',
            name='service',
            field=models.ManyToManyField(through='products.RoomService', to='products.Service'),
        ),
        migrations.CreateModel(
            name='ProductImage',
            fields=[
